...
def make_seg(idx, s, e):
    ...
    # if leaf node, put numbers itself.
    if s == e:
        seg[idx] = arr[s]
        return seg[idx]
    ...
    # multiply lower left and lower right number.
...
def get(idx, s, e):
    ...
    # using lower nodes and multiply lower left and right
    else: 
        l = get(idx * 2, s, mid)
